...
function HeroIllustration() {
  return (
    ...
    >
      ...
      {/* Leaves */}
      <path
        d="M250 160 C253 147 263 140 266 133"
        stroke="#6F7A63"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeOpacity="0.52"
      />
      <path
        d="M250 154 C246 142 236 137 233 130"
        stroke="#6F7A63"
        strokeWidth="1.75"
        strokeLinecap="round"
        strokeOpacity="0.4"
      />
      <path
        d="M250 162 C255 152 259 145 257 137"
        stroke="#6F7A63"
        strokeWidth="1.25"
        strokeLinecap="round"
        strokeOpacity="0.32"
      ...
      />
      <path
        d="M221 118 C221 104 228 93 226 80"
        stroke="#6F7A63"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeOpacity="0.38"
      />
      <path
        d="M221 111 C215 100 206 97 204 89"
        stroke="#6F7A63"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeOpacity="0.32"
      />
      <path
        d="M221 108 C228 98 235 96 237 88"
        stroke="#6F7A63"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeOpacity="0.26"
      />
      <path
        d="M221 114 C218 106 213 101 210 94"
        stroke="#6F7A63"
        strokeWidth="1"
        strokeLinecap="round"
        strokeOpacity="0.22"
...
const feedbackStats = [
  {
    value: "4",
    label: "post-session feedback forms received",
  },
  {
    value: "5/5",
    label: "rating from all submitted feedback",
  },
  {
    value: "100%",
    label: "said they would consider booking again",
  },
  {
    value: "Permission-based",
    label: "names shown only with client approval",
  },
];
  ...
  return (
    <div>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {trustStrip.map((item) => (
              ...
              >
                <Icon
                  name="check"
                  className="h-4 w-4 text-olive flex-shrink-0"
                />
                <span>{item}</span>
              </div>
            ))}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="text-center max-w-2xl mx-auto mb-8">
            ...
            <p className="mt-2 text-charcoal/70">
              From a first reset to ongoing home or office cleaning, plus light
              organizing for calmer everyday spaces.
            </p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="mt-3 text-charcoal/70">
              ...
              required. You will receive a clear estimate before confirming your
              booking.
            </p>
          </div>
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <section id="feedback" className="bg-cream scroll-mt-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
            {feedbackStats.map((item) => (
              <div
                key={item.label}
                className="rounded-2xl bg-white/80 border border-olive/15 px-5 py-4 text-center shadow-sm"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-olive/15 p-6 sm:p-8 flex flex-col">
              <p className="text-charcoal/80 leading-relaxed italic flex-1">
                ...
                immediately and left her alone in my apartment. Can&apos;t wait
                for next visit.&rdquo;
              </p>
            ...
            <div className="bg-white rounded-2xl border border-olive/15 p-6 sm:p-8 flex flex-col">
              <p className="text-charcoal/80 leading-relaxed italic flex-1">
                &ldquo;I really admire Ms. Lily&apos;s consistent
                professionalism and her systematic and expertise on the job. She
                literally knows what she&apos;s doing and shares the rationale
                behind her system.
                <br />
                <br />
                She respects people&apos;s time, and my wishes for my home and
                treats my place with care. ❣️
                <br />
                <br />
                It&apos;s not easy to find someone who&apos;s as professional
                and as good as she is in Berlin.
                <br />
                <br />
            ...
            <div className="bg-white rounded-2xl border border-olive/15 p-6 sm:p-8 flex flex-col">
              <p className="text-charcoal/80 leading-relaxed italic flex-1">
                &ldquo;Very satisfied with your services &amp; all of the
                customer service. I also appreciated that you arrived before the
                scheduled time and we were able to discuss what was needed, and
                also when the session finished. Thank you again!&rdquo;
              </p>
              <p className="text-sm font-medium text-charcoal mt-6">
                — Tina, home cleaning client
              </p>
            </div>
          </div>
