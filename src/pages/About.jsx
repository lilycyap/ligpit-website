...
export default function About() {
  return (
    <div className="bg-cream">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 pb-12 sm:pb-20">
        <div className="text-center mb-8">
          <p className="text-sm uppercase tracking-[0.2em] text-gold font-medium mb-3">
            About Ligpit
          </p>
          <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl leading-[1.12] tracking-tight text-charcoal">
        ...
        <div className="bg-white rounded-2xl border border-olive/15 p-6 sm:p-10">
          <div className="flex flex-col md:flex-row gap-8 items-center md:items-stretch mb-8">
            ...
            <div className="w-full md:w-2/5 flex-shrink-0">
              <div className="rounded-2xl overflow-hidden border border-olive/20 h-56 sm:h-72 md:h-full">
                <img
                  src="/lily.png"
